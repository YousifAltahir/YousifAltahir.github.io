/* ============================================================
   icons.js — inline SVG registry (no external requests).
   Brand marks from Simple Icons; UI glyphs are simple strokes.
   Use:  icon('github')  ->  returns an <svg> string.
   ============================================================ */

export const ICONS = {
  // Brand marks (filled, 24x24 viewBox)
  github:
  ...
  // UI glyphs (stroked, 24x24 viewBox)
  mail:
    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2.5" y="4.5" width="19" height="15" rx="2.5"/><path d="m3 6 9 6 9-6"/></svg>',
  download:
